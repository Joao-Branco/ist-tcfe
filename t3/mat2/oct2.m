...
ripplee=max(vO)-vOmin;
ripplef=ripplee*459.828/(459.828+100*10^3);


printf("ripple_TAB\n")
Min = vOmin* 12 /169.9608
Ripple = ripplef
Max = max(vO)* 12 /169.9608
printf("ripple_END\n");
...
figure
plot(t*1000, vOf)
axis([1e-3*1000, 200e-3*1000, 8, 13])
grid on
title("Output voltage v_o(t)")
xlabel ("t[ms]")
legend("Voltage Regulator","envelope")
